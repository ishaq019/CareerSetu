...
4. Add Environment Variables (Project → Settings → Environment Variables):
   ...
   - `LLM_API_KEY` (OpenRouter key from https://openrouter.ai/keys) — optional; AI routes return 503 without it
   - `LLM_MODEL` — optional; defaults to a free-tier slug (`google/gemma-4-26b-a4b-it:free`). Override with any model from https://openrouter.ai/models?max_price=0
